describe("Schedule Mark API - DELETE Schedule Mark By Id", () => {
    const url = "/api/schedule_marks"
    ...
    describe("Failed cases", () => {
        it("should fail if the schedule mark is deleted by admin", () => {
            cy.request({
                method: "DELETE",
                url: `${url}/${id.schedule_mark}`, 
                headers: {
        ...
        it("should fail if the schedule mark not found", () => {
            cy.request({
                method: "DELETE",
    ...
    describe("Success cases", () => {
        it("should delete schedule mark successfully with valid id", () => {
            cy.request({
                method: "DELETE", 
                url: `${url}/${id.schedule_mark}`, 
                headers: {
                ...
                cy.expectDefaultResponseProps(res, 200, 'Delete schedule mark successful')
            })
        })
    })
})