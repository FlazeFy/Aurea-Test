describe("Inventory API - DELETE Inventory By Id", () => {
    ...
    describe("Failed cases", () => {
        it("should fail if the inventory is deleted by admin", () => {
            cy.request({
                method: "DELETE",
                url: `${url}/${id.inventory}`, 
                headers: {
        ...
        it("should fail if the inventory not found", () => {
            cy.request({
                method: "DELETE",
                ...
                cy.expectDefaultResponseProps(res, 404, 'Inventory not found')
            })
        })
    ...
    describe("Success cases", () => {
        it("should delete inventory successfully with valid id", () => {
            cy.request({
                method: "DELETE", 
                url: `${url}/${id.inventory}`, 
                headers: {
                ...
                cy.expectDefaultResponseProps(res, 200, 'Delete inventory successful')
            })
        })
    })
})