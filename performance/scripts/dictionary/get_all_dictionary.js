...
// Performance Test : PERF-DICT-GADT-001
// Multiple users see all dictionary simultaneously
...
export default function () {
    ...
    const url = `${BASE_URL}/api/v1/dictionaries`
    const params = {
        headers: {
    ...
    check(res, {
        ...
        "get dictionary success": (r) => r.json("message") === "Get dictionary successful",
    })
