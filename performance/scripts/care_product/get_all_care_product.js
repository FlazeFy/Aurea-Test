...
// Performance Test : PERF-CRPD-GACP-001
// Multiple users see care product simultaneously
...
export default function () {
    ...
    const url = `${BASE_URL}/api/v1/care_products`
    const params = {
        headers: {
    ...
    check(res, {
        ...
        "get all care product success": (r) => r.json("message") === "Get care product successful",
    })
